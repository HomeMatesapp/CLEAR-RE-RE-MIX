// Actor flavor for the shared modular payload builder.
//
// The course/accreditation caution is ALWAYS the caution card for Actor —
// it never depends on `checks_before_committing`. See engine
// `shouldShowCourseCaution` for the trigger rules.

import type { ModularPayloadFlavor } from "./modular-payload";
import type { ActorRouteId } from "./actor";
...
export const actorFlavor: ModularPayloadFlavor<ActorRouteId> = {
  ...
  // Default caution card is the course caution — see adapter for switching.
